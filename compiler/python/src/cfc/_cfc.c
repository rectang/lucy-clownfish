...
static PyObject*
S_CFCPyClass_add_py_method_def(PyObject *wrapper, PyObject *def) {
    CFCPyClass *self = S_to_PyClass(wrapper);
    CFCPyClass_add_py_method_def(self, PyUnicode_AsUTF8(def));
    Py_RETURN_NONE;
}
...
static PyMethodDef pyclass_methods[] = {
    ...
    {"add_py_method_def", (PyCFunction)S_CFCPyClass_add_py_method_def, METH_O, NULL},
