...
/* Constructor.
 *
 * @param usage Invocation instructions.
 */
chaz_CLI*
chaz_CLI_new(const char *usage);
 ...
 * values.  Returns true on success, or sets error and returns false if the
...
/* Return the value of an option as a C string.  Defaults to NULL.
 */
const char*
